...
export const metadata = {
  ...
  description:
    'Palace Porta Potties delivers clean, serviced portable restrooms across seven markets with confirmed scheduling and transparent pricing - call (888) 708-5771 for a quote.',
    ...
    <>
      ...
      <section className="about-story">
        <div className="container">
          ...
          <p>
            ...
            documented process - the Palace Standard&trade;.
          </p>
          <p>
            Every unit we deliver passes the <strong>Palace Clean Check&trade;</strong> before it
      ...
      <section className="about-markets">
        <div className="container">
          ...
          <hr className="gold-rule" />
          <p>
            Palace operates from yards in seven of the toughest rental markets in the country.
            Each location is structured for a matching GBP and staffed by a local dispatch team
            that understands permits, venue access, and seasonal demand in their city.
          </p>
      ...
      <section className="about-standards">
        <div className="container">
          <h2>The Palace Standard&trade;</h2>
          <hr className="gold-rule" />
          <ul className="service-list">
            <li><strong>Palace Clean Check&trade;</strong> - documented pre-delivery inspection on every unit</li>
